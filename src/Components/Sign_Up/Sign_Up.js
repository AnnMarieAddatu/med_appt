...
function Sign_Up() {
  ...
  const isValidPhone = (phone) => {
    // Implement phone number validation logic (10 digits)
  };
        ...
        <div className="signup-form">
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <input name="password" id="password" required className="form-control" placeholder="Enter your password" aria-describedby="helpId" onChange={handleChange} />
            </div>
